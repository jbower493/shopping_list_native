...
export function NewRecipeCategory() {
    const [isOpen, setIsOpen] = useState(false)

    const { mutateAsync: createRecipeCategory } = query.recipeCategories.create.useMutation()
    ...
    return (
        <View>
            ...
            <Modal isOpen={isOpen} close={() => setIsOpen(false)} title='New Recipe Category'>
                <View>
